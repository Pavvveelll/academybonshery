...
/*$settings["files"]["dir"] 	= "./FileUpload/files/"; //with the trailing slash!
$settings["files"]["url_dir"] 	= "FileUpload/files/"; //with the trailing slash!
$settings["files"]["ext"] 	= array("*");
$settings["files"]["type"] 	= 1; //1 => file browser, 2 => image browser*/
$settings["img"]["dir"] 	= "../picture/img/"; //with the trailing slash!
$settings["img"]["url_dir"] 	= "/picture/img/"; //with the trailing slash!
$settings["img"]["ext"] 	= array("jpeg","jpg", "bmp", "png", "gif");
$settings["img"]["type"] 	= 2; //1 => file browser, 2 => image browser
/*$settings["media"]["dir"] 	= "./FileUpload/files/"; //with the trailing slash!
$settings["media"]["url_dir"] 	= "FileUpload/files/"; //with the trailing slash!
